...
const HomeComponent = () => {
  ...
  <svg className="responsive-svg" preserveAspectRatio="none" width={1080} height={2212} viewBox="0 0 1080 2212">
    <defs>
      <style>
        {
          ".a,.b{fill:#013993;}.b,.d{clip-rule:evenodd;}.c,.d,.g,.h,.qu,.qw,.qx,.qz{fill:none;}.e{fill:url(#a);}.dp,.f{fill:#42bef4;}.g{stroke:#707070;}.ax,.by,.dn,.dp,.ee,.h,.ra,.w{fill-rule:evenodd;}.i,.pp,.pq{fill:url(#b);}.j{clip-path:url(#sv);}.k{fill:url(#d);}.l{opacity:0.58;}.m{clip-path:url(#e);}.n{clip-path:url(#f);}.bh,.o{opacity:0.76;}.dc,.dk,.dy,.et,.jl,.jq,.o,.u{mix-blend-mode:multiply;}.ae,.bh,.cv,.cy,.dc,.dh,.dk,.dy,.ef,.em,.et,.jl,.jq,.ma,.me,.o,.u{isolation:isolate;}.p{clip-path:url(#h);}.q{fill:#00004d;}.r{clip-path:url(#i);}.s{clip-path:url(#j);}.t{fill:url(#k);}.em,.ex,.me,.u{opacity:0.5;}.v{clip-path:url(#m);}.w,.z{fill:#9f1010;}.x{clip-path:url(#n);}.y{clip-path:url(#o);}.aa{clip-path:url(#p);}.ab{clip-path:url(#q);}.ac{clip-path:url(#r);}.ad,.ax{fill:#7a369e;}.ae,.me{mix-blend-mode:color-dodge;}.af{clip-path:url(#s);}.ag{fill:#c9bc57;}.ah{clip-path:url(#t);}.ai{clip-path:url(#u);}.aj{clip-path:url(#v);}.ak{clip-path:url(#w);}.al{clip-path:url(#x);}.am{clip-path:url(#y);}.an{clip-path:url(#z);}.ao{clip-path:url(#aa);}.ap{clip-path:url(#ab);}.aq{clip-path:url(#ac);}.ar{clip-path:url(#ad);}.as{clip-path:url(#ae);}.at{clip-path:url(#af);}.au{clip-path:url(#ag);}.av{clip-path:url(#ah);}.aw{clip-path:url(#ai);}.ay{clip-path:url(#aj);}.az{clip-path:url(#ak);}.ba{clip-path:url(#al);}.bb{clip-path:url(#am);}.bc{clip-path:url(#an);}.bd{clip-path:url(#ao);}.be{clip-path:url(#ap);}.bf{clip-path:url(#aq);}.bg{clip-path:url(#ar);}.bh,.ef,.em,.ma{mix-blend-mode:screen;}.bi{clip-path:url(#as);}.bj{clip-path:url(#at);}.bk{fill:url(#au);}.bl{clip-path:url(#av);}.bm{clip-path:url(#aw);}.bn{fill:url(#ax);}.bo{clip-path:url(#ay);}.bp{clip-path:url(#az);}.bq{fill:url(#ba);}.br{clip-path:url(#bb);}.bs{clip-path:url(#bc);}.bt{clip-path:url(#bd);}.bu{fill:url(#be);}.bv{clip-path:url(#bf);}.bw{clip-path:url(#bg);}.bx{fill:url(#bh);}.by,.dn,.qr,.rc{fill:#fff;}.bz{clip-path:url(#bi);}.ca{clip-path:url(#bj);}.cb{clip-path:url(#bk);}.cc{fill:#80001b;}.cd{clip-path:url(#bl);}.ce{clip-path:url(#bm);}.cf{fill:url(#bn);}.cg{clip-path:url(#bp);}.ch{clip-path:url(#bq);}.ci{fill:url(#br);}.cj{clip-path:url(#bt);}.ck{clip-path:url(#bu);}.cl{fill:url(#bv);}.cm{clip-path:url(#bx);}.cn{clip-path:url(#by);}.co{fill:url(#bz);}.cp{clip-path:url(#cb);}.cq{clip-path:url(#cc);}.cr{fill:url(#cd);}.cs{clip-path:url(#cf);}.ct{clip-path:url(#cg);}.cu{fill:url(#ch);}.cv{opacity:0.89;mix-blend-mode:overlay;}.cw{clip-path:url(#ck);}.cx{fill:url(#cl);}.cy,.dc{opacity:0.77;}.cy{mix-blend-mode:hue;}.cz{clip-path:url(#cm);}.da{clip-path:url(#cn);}.db{fill:url(#co);}.dd{clip-path:url(#cs);}.de{clip-path:url(#ct);}.df{fill:url(#cu);}.dg{clip-path:url(#cv);}.dh{mix-blend-mode:soft-light;}.di{clip-path:url(#cw);}.dj{clip-path:url(#cx);}.dl{clip-path:url(#cy);}.dm{clip-path:url(#cz);}.dn{opacity:0.25;}.do{clip-path:url(#da);}.dp{opacity:0.61;}.dq{clip-path:url(#db);}.dr{clip-path:url(#dc);}.ds{fill:url(#dd);}.dt{clip-path:url(#de);}.du{fill:url(#df);}.dv{clip-path:url(#dh);}.dw{clip-path:url(#di);}.dx{fill:url(#dj);}.dy{opacity:0.7;}.dz{clip-path:url(#dk);}.ea{clip-path:url(#dl);}.eb{fill:url(#dm);}.ec,.et{opacity:0.2;}.ed{clip-path:url(#dn);}.ee{fill:#86feff;}.ef{opacity:0.3;}.eg{clip-path:url(#do);}.eh{clip-path:url(#dp);}.ei{fill:url(#dq);}.ej{clip-path:url(#dr);}.ek{clip-path:url(#ds);}.el{fill:url(#dt);}.en{clip-path:url(#du);}.eo{clip-path:url(#dv);}.ep{fill:url(#dw);}.eq{clip-path:url(#dx);}.er{clip-path:url(#dy);}.es{fill:url(#dz);}.eu{clip-path:url(#ea);}.ev{clip-path:url(#eb);}.ew{fill:url(#ec);}.ey{clip-path:url(#ed);}.ez{clip-path:url(#ee);}.fa{fill:url(#ef);}.fb{clip-path:url(#eg);}.fc{clip-path:url(#eh);}.fd{fill:url(#ei);}.fe{clip-path:url(#ej);}.ff{clip-path:url(#ek);}.fg{fill:url(#el);}.fh{clip-path:url(#em);}.fi{clip-path:url(#en);}.fj{fill:url(#eo);}.fk{clip-path:url(#ep);}.fl{clip-path:url(#eq);}.fm{fill:url(#er);}.fn{clip-path:url(#es);}.fo{clip-path:url(#et);}.fp{fill:url(#eu);}.fq{clip-path:url(#ev);}.fr{fill:url(#ew);}.fs{clip-path:url(#ex);}.ft{fill:url(#ey);}.fu{clip-path:url(#ez);}.fv{fill:url(#fa);}.fw{clip-path:url(#fc);}.fx{clip-path:url(#fd);}.fy{fill:url(#fe);}.fz{clip-path:url(#ff);}.ga{clip-path:url(#fg);}.gb{fill:url(#fh);}.gc{clip-path:url(#fi);}.gd{clip-path:url(#fj);}.ge{fill:url(#fk);}.gf{clip-path:url(#fl);}.gg{clip-path:url(#fm);}.gh{fill:url(#fn);}.gi{clip-path:url(#fo);}.gj{clip-path:url(#fp);}.gk{fill:url(#fq);}.gl{clip-path:url(#fr);}.gm{clip-path:url(#fs);}.gn{clip-path:url(#ft);}.go{fill:url(#fu);}.gp{clip-path:url(#fv);}.gq{clip-path:url(#fw);}.gr{fill:url(#fx);}.gs{clip-path:url(#fy);}.gt{clip-path:url(#fz);}.gu{fill:url(#ga);}.gv{opacity:0.58;}.gw{clip-path:url(#gb);}.gx{clip-path:url(#gc);}.gy{fill:url(#gd);}.gz{clip-path:url(#ge);}.ha{fill:url(#gf);}.hb{clip-path:url(#gg);}.hc{fill:url(#gh);}.hd{clip-path:url(#gj);}.he{clip-path:url(#gk);}.hf{fill:url(#gl);}.hg{clip-path:url(#gm);}.hh{clip-path:url(#gn);}.hi{fill:url(#go);}.hj{clip-path:url(#gp);}.hk{fill:url(#gq);}.hl{clip-path:url(#gr);}.hm{fill:url(#gs);}.hn{clip-path:url(#gt);}.ho{fill:url(#gu);}.hp{clip-path:url(#gv);}.hq{fill:url(#gw);}.hr{clip-path:url(#gy);}.hs{clip-path:url(#gz);}.ht{fill:url(#ha);}.hu{clip-path:url(#hb);}.hv{clip-path:url(#hc);}.hw{fill:url(#hd);}.hx{clip-path:url(#he);}.hy{clip-path:url(#hf);}.hz{fill:url(#hg);}.ia{clip-path:url(#hh);}.ib{clip-path:url(#hi);}.ic{clip-path:url(#hj);}.id{fill:url(#hk);}.ie{clip-path:url(#hl);}.if{clip-path:url(#hm);}.ig{fill:url(#hn);}.ih{clip-path:url(#ho);}.ii{clip-path:url(#hp);}.ij{fill:url(#hq);}.ik{clip-path:url(#hr);}.il{clip-path:url(#hs);}.im{fill:url(#ht);}.in{clip-path:url(#hu);}.io{clip-path:url(#hv);}.ip{fill:url(#hw);}.iq{clip-path:url(#hx);}.ir{clip-path:url(#hy);}.is{fill:url(#hz);}.it{clip-path:url(#ia);}.iu{clip-path:url(#ib);}.iv{fill:url(#ic);}.iw{clip-path:url(#id);}.ix{fill:url(#ie);}.iy{clip-path:url(#if);}.iz{fill:url(#ig);}.ja{clip-path:url(#ih);}.jb{fill:url(#ii);}.jc{clip-path:url(#ij);}.jd{clip-path:url(#ik);}.je{fill:url(#il);}.jf{clip-path:url(#im);}.jg{fill:url(#in);}.jh{clip-path:url(#io);}.ji{fill:url(#ip);}.jj{clip-path:url(#iq);}.jk{fill:url(#ir);}.jl{opacity:0.4;}.jm{clip-path:url(#it);}.jn{fill:#7a7772;}.jo{clip-path:url(#iu);}.jp{fill:url(#iv);}.jq{opacity:0.8;}.jr{clip-path:url(#ix);}.js{fill:#988aa1;}.jt{clip-path:url(#iy);}.ju{fill:url(#iz);}.jv{clip-path:url(#jb);}.jw{clip-path:url(#jc);}.jx{fill:url(#jd);}.jy{clip-path:url(#je);}.jz{fill:url(#jf);}.ka{clip-path:url(#jg);}.kb{fill:url(#jh);}.kc{clip-path:url(#jj);}.kd{clip-path:url(#jk);}.ke{clip-path:url(#jl);}.kf{fill:url(#jm);}.kg{clip-path:url(#jo);}.kh{clip-path:url(#jp);}.ki{clip-path:url(#jq);}.kj{clip-path:url(#jr);}.kk{clip-path:url(#js);}.kl{clip-path:url(#jt);}.km{clip-path:url(#ju);}.kn{clip-path:url(#jv);}.ko{fill:#9aa45b;}.kp{clip-path:url(#jw);}.kq{fill:#91bf53;}.kr{clip-path:url(#jx);}.ks{clip-path:url(#jy);}.kt{fill:url(#jz);}.ku{clip-path:url(#ka);}.kv{fill:url(#kb);}.kw{clip-path:url(#kd);}.kx{clip-path:url(#ke);}.ky{fill:url(#kf);}.kz{clip-path:url(#kg);}.la{clip-path:url(#kh);}.lb{fill:url(#ki);}.lc{fill:#c570ff;}.ld{clip-path:url(#kj);}.le{fill:url(#kk);}.lf{clip-path:url(#km);}.lg{clip-path:url(#kn);}.lh{fill:url(#ko);}.li{clip-path:url(#kp);}.lj{clip-path:url(#kq);}.lk{fill:url(#kr);}.ll{clip-path:url(#ks);}.lm{fill:url(#kt);}.ln{clip-path:url(#kv);}.lo{clip-path:url(#kw);}.lp{fill:url(#kx);}.lq{clip-path:url(#ky);}.lr{clip-path:url(#kz);}.ls{fill:url(#la);}.lt{clip-path:url(#lb);}.lu{fill:url(#lc);}.lv{clip-path:url(#le);}.lw{clip-path:url(#lf);}.lx{fill:url(#lg);}.ly{clip-path:url(#lh);}.lz{clip-path:url(#li);}.mb{clip-path:url(#lj);}.mc{clip-path:url(#lk);}.md{fill:url(#ll);}.mf{clip-path:url(#lm);}.mg{clip-path:url(#ln);}.mh{fill:url(#lo);}.mi{clip-path:url(#lp);}.mj{clip-path:url(#lq);}.mk{fill:url(#lr);}.ml{clip-path:url(#ls);}.mm{clip-path:url(#lt);}.mn{fill:url(#lu);}.mo{clip-path:url(#lv);}.mp{clip-path:url(#lw);}.mq{fill:url(#lx);}.mr{clip-path:url(#ly);}.ms{clip-path:url(#lz);}.mt{fill:url(#ma);}.mu{clip-path:url(#mb);}.mv{clip-path:url(#mc);}.mw{fill:url(#md);}.mx{clip-path:url(#me);}.my{clip-path:url(#mf);}.mz{fill:url(#mg);}.na{clip-path:url(#mh);}.nb{clip-path:url(#mi);}.nc{fill:url(#mj);}.nd{clip-path:url(#mk);}.ne{clip-path:url(#ml);}.nf{fill:url(#mm);}.ng{clip-path:url(#mn);}.nh{clip-path:url(#mo);}.ni{fill:url(#mp);}.nj{clip-path:url(#mq);}.nk{clip-path:url(#mr);}.nl{fill:url(#ms);}.nm{clip-path:url(#mt);}.nn{clip-path:url(#mu);}.no{fill:url(#mv);}.np{clip-path:url(#mw);}.nq{clip-path:url(#mx);}.nr{fill:url(#my);}.ns{fill:url(#mz);}.nt{opacity:0.59;fill:url(#na);}.nu{opacity:0.44;fill:url(#nb);}.nv{fill:#1756a2;}.nw{fill:url(#nf);}.nx{fill:url(#nh);}.ny{clip-path:url(#ni);}.nz{fill:#004993;}.oa,.pl,.pp,.qu{stroke:#04105b;}.oa,.pl{stroke-width:10px;}.oa{fill:url(#nj);}.ob,.pu{fill:url(#nk);}.oc{fill:#153d77;}.oc,.pn{font-size:70px;}.oc,.od,.pn,.po,.rc{font-family:MADETOMMY-ExtraBold, MADE TOMMY;font-weight:800;}.od{fill:#1f73b8;}.od,.po,.rc{font-size:40px;}.oe{clip-path:url(#pf);}.of{clip-path:url(#pg);}.og{clip-path:url(#ph);}.oh{clip-path:url(#pi);}.oi{clip-path:url(#pk);}.oj{clip-path:url(#pl);}.ok{clip-path:url(#pn);}.ol{clip-path:url(#po);}.om{clip-path:url(#pq);}.on{clip-path:url(#pr);}.oo{clip-path:url(#pt);}.op{clip-path:url(#pu);}.oq{clip-path:url(#pw);}.or{clip-path:url(#px);}.os{clip-path:url(#pz);}.ot{clip-path:url(#qa);}.ou{clip-path:url(#qc);}.ov{clip-path:url(#qd);}.ow{clip-path:url(#qf);}.ox{clip-path:url(#qg);}.oy{clip-path:url(#qi);}.oz{clip-path:url(#qj);}.pa{clip-path:url(#ql);}.pb{clip-path:url(#qm);}.pc{clip-path:url(#qo);}.pd{clip-path:url(#qp);}.pe{clip-path:url(#qr);}.pf{clip-path:url(#qs);}.pg{clip-path:url(#qu);}.ph{clip-path:url(#qv);}.pi{clip-path:url(#qx);}.pj{fill:#042648;}.pk{clip-path:url(#qy);}.pl{fill:url(#rh);}.pm{fill:url(#ri);}.pn{fill:#462e00;}.po{fill:#6e4800;}.pp,.pq,.qe,.qz{stroke-linecap:round;stroke-linejoin:round;}.pp{stroke-width:60px;}.pq{stroke:#671304;stroke-width:30px;}.pr{clip-path:url(#rz);}.ps{fill:url(#sc);}.pt{fill:url(#sd);}.pu{opacity:0.55;}.pv{fill:#f5b445;}.pw{fill:#04105b;}.px{fill:#ffcb5b;}.py{fill:#ab6c00;}.pz{fill:#f6b545;}.qa{fill:#ffe27a;}.qb{fill:#ffbe1b;}.qc{fill:#613d00;}.qd{fill:#fff347;}.qe,.qf{fill:#3173e7;}.qg{fill:#3bb54a;}.qh{fill:#aed477;}.qi{fill:#e7f5fd;}.qj{fill:#5eadef;}.qk{fill:#76b9f1;}.ql{fill:#a0cef6;}.qm{fill:#89c763;}.qn{fill:#025e2d;}.qo{fill:#b0c4d9;}.qp{fill:#d5e3ef;}.qq{fill:#485f77;}.qs{fill:#c9d5e3;}.qt{fill:#0b3a5b;}.qu{stroke-width:15px;}.qv{fill:#888;}.qw{stroke:#004d18;}.qw,.qx{stroke-width:3px;}.qx{stroke:#008529;}.qy{fill:url(#sj);}.qz{stroke:#68402a;stroke-width:4px;stroke-dasharray:8 8;}.ra{fill:url(#sk);}.rb{fill:url(#sl);}.rd,.re{stroke:none;}.re{fill:#04105b;}.rf{fill:url(#c);}.rg{filter:url(#ss);}.rh{filter:url(#sq);}.ri{filter:url(#so);}.rj{filter:url(#sm);}.rk{filter:url(#se);}.rl{filter:url(#rn);}.rm{filter:url(#rj);}.rn{filter:url(#rf);}.ro{filter:url(#rb);}.rp{filter:url(#nl);}"
        }
      </style>
      <linearGradient
        id="a"
      ...
      >
        ...
        <stop offset={1} stopColor="#fec11b" />
      </linearGradient>
      <linearGradient
        id="c"
        x1={0.5}
      ...
      >
        <feOffset dy={3} input="SourceAlpha" />
        <feGaussianBlur stdDeviation={3} result="rc" />
        <feFlood floodColor="#0d8cc1" />
        <feComposite operator="in" in2="rc" />
        <feComposite in="SourceGraphic" />
      </filter>
      <filter
        id="rf"
      ...
      >
        <feOffset dy={3} input="SourceAlpha" />
        <feGaussianBlur stdDeviation={3} result="rg" />
        <feFlood floodColor="#0d8cc1" />
        <feComposite operator="in" in2="rg" />
        <feComposite in="SourceGraphic" />
      </filter>
      <linearGradient
        id="rh"
      ...
      >
        ...
        <stop offset={1} stopColor="#ffeaa4" />
      </linearGradient>
      <filter
        id="rj"
        x={75}
      ...
      >
        <feOffset dy={3} input="SourceAlpha" />
        <feGaussianBlur stdDeviation={3} result="rk" />
        <feFlood floodColor="#bf7d00" />
        <feComposite operator="in" in2="rk" />
        <feComposite in="SourceGraphic" />
      </filter>
      <filter
        id="rn"
      ...
      >
        <feOffset dy={3} input="SourceAlpha" />
        <feGaussianBlur stdDeviation={3} result="ro" />
        <feFlood floodColor="#0d8cc1" />
        <feComposite operator="in" in2="ro" />
        <feComposite in="SourceGraphic" />
      </filter>
      <clipPath id="rz">
        <rect className="i" width={380.204} height={101.815} />
      </clipPath>
      <linearGradient
        id="sc"
        x1={0.5}
      ...
      >
        <feOffset dy={3} input="SourceAlpha" />
        <feGaussianBlur stdDeviation={10} result="sf" />
        <feFlood floodOpacity={0.161} />
        <feComposite operator="in" in2="sf" />
        <feComposite in="SourceGraphic" />
      </filter>
      <linearGradient
        id="sj"
      ...
      >
        <feOffset dy={3} input="SourceAlpha" />
        <feGaussianBlur stdDeviation={3} result="sn" />
        <feFlood floodOpacity={0.161} />
        <feComposite operator="in" in2="sn" />
        <feComposite in="SourceGraphic" />
      </filter>
      <filter
        id="so"
      ...
      >
        <feOffset dy={3} input="SourceAlpha" />
        <feGaussianBlur stdDeviation={3} result="sp" />
        <feFlood floodOpacity={0.161} />
        <feComposite operator="in" in2="sp" />
        <feComposite in="SourceGraphic" />
      </filter>
      <filter
        id="sq"
      ...
      >
        <feOffset dy={3} input="SourceAlpha" />
        <feGaussianBlur stdDeviation={3} result="sr" />
        <feFlood floodOpacity={0.161} />
        <feComposite operator="in" in2="sr" />
        <feComposite in="SourceGraphic" />
      </filter>
      <filter
        id="ss"
      ...
      >
        <feOffset dy={3} input="SourceAlpha" />
        <feGaussianBlur stdDeviation={3} result="st" />
        <feFlood floodOpacity={0.161} />
        <feComposite operator="in" in2="st" />
        <feComposite in="SourceGraphic" />
      </filter>
      <clipPath id="sv">
    ...
    <g id="su" className="j">
      <rect className="rf" width={1080} height={2212} />
      <rect
        className="k"
        width={1388}
        height={1154}
      ...
      <g transform="translate(46 254.801)">
        <g className="pi" transform="translate(0 0)">
          <path
            className="pj"
      ...
      <g transform="translate(176.958 235.813)">
        <g className="pk" transform="translate(0 0)">
          <path
            className="pj"
      ...
      <g transform="translate(-10544.318 -2531.36)">
        <g transform="translate(10894.318 2705.549)">
          <g transform="translate(0 3.306)">
            <path
              className="pp"
              d="M0,0V101.8H69.231V77.077H30.11V62.258H63.131V38.7H30.11V24.86H67.787V0Z"
              transform="translate(0 0.004)"
            />
            <path
              className="pp"
              d="M58.846,29.237l9.6,34.755h-19.2ZM40.231,0,6.192,101.8H38.764l4.523-16.286H74.4L78.927,101.8H111.5L77.46,0Z"
              transform="translate(68.896 0)"
            />
            <path
              className="pp"
              d="M56.758,69.085H45.71v32.73H15.6V0H57.34C85.4,0,99.079,14.115,99.079,36.513c0,12.939-5.227,21.816-14.54,26.909l21.67,38.393H73.335ZM45.71,45.523H57.34c6.827,0,11.35-2.316,11.35-9.01,0-6.112-3.5-9.168-11.35-9.168H45.71Z"
              transform="translate(173.575 0)"
            />
            <path
              className="pp"
              d="M115.436,0V101.815H88.527L53.918,47.56v54.254H23.8V0H50.716L85.471,54.254V0Z"
              transform="translate(264.762 0)"
            />
          </g>
          <g transform="translate(0 3.306)">
            <path
          ...
          <g transform="translate(0 0)">
            ...
            <path
              className="i"
              d="M58.846,29.237l9.6,34.755h-19.2ZM40.231,0,6.192,101.8H38.764l4.523-16.286H74.4L78.927,101.8H111.5L77.46,0Z"
              transform="translate(68.896 0.006)"
            />
            <g transform="translate(0 0)">
              <g className="pr">
                <path
                  className="i"
                  d="M56.758,69.085H45.71v32.73H15.6V0H57.34C85.4,0,99.079,14.115,99.079,36.513c0,12.939-5.227,21.816-14.54,26.909l21.67,38.393H73.335ZM45.71,45.523H57.34c6.827,0,11.35-2.316,11.35-9.01,0-6.112-3.5-9.168-11.35-9.168H45.71Z"
                  transform="translate(173.574 0.006)"
                />
                <path
                  className="i"
                  d="M115.436,0V101.815H88.527L53.918,47.56v54.254H23.8V0H50.716L85.471,54.254V0Z"
                  transform="translate(264.762 0.006)"
                />
              </g>
            </g>
          </g>
      ...
      <g transform="translate(0 15)">
        <g transform="translate(0 8.204)">
          ...
          />
          <g className="rk" transform="matrix(1, 0, 0, 1, 0, -23.2)">
            <rect
              className="pt"
              width={1080}
              height={17}
      ...
      <Link to="/earn">
      <g className="rj" transform="matrix(1, 0, 0, 1, 0, 0)">
        <text className="rc" transform="translate(82.9 2157.79)">
          <tspan x={0} y={0}>
            {"Earn"}
          </tspan>
        </text>
      ...
      <Link to="/invite">
      <g className="ri" transform="matrix(1, 0, 0, 1, 0, 0)">
        <text className="rc" transform="translate(349 2157.79)">
          <tspan x={0} y={0}>
            {"Invite"}
          </tspan>
        </text>
      ...
      <g transform="translate(339.721 1974.367)">
        <g className="qe" transform="translate(0 0)">
          <path
            className="rd"
      ...
      <g className="rh" transform="matrix(1, 0, 0, 1, 0, 0)">
        <text className="rc" transform="translate(627 2157.79)">
          <tspan x={0} y={0}>
            {"Trade"}
          </tspan>
        </text>
      ...
      <g className="rg" transform="matrix(1, 0, 0, 1, 0, 0)">
        <text className="rc" transform="translate(896 2157.79)">
          <tspan x={0} y={0}>
            {"Wallet"}
          </tspan>
        </text>
