...
import walletAnimation from '../assets/wallet_animation.gif';
  ...
  return (
    ...
    <svg className="responsive-svg" preserveAspectRatio="none" width={1080} height={2212} viewBox="0 0 1080 2212">
      ...
      <g id="th" className="i">
        ...
        <image href={walletAnimation} x="0" y="225" width="1080" height="1080" />
        ...
        <Link to="/spin">
          <image x="875" y="-20" width="222" height="216" xlinkHref="Spin.png" />
        </Link>
      </g>
    </svg>
    </div>
